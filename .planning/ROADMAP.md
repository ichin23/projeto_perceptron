...
|---|-------|------|--------------|--------|
| 1 | Setup & Data | Prepare environment and training data file. | DATA-01, DATA-02, DATA-03 | Pending |
| 2 | Algorithm | Implement the Perceptron and Hebbian update rule. | ALGO-01, ALGO-02, ALGO-03, ALGO-04 | Pending |
| 3 | Execution | Implement the 5-run training loop and report results. | TRAIN-01, TRAIN-02, TRAIN-03, TRAIN-04 | Pending |
...
### Phase 3: Execution
Implement the logic to run the training 5 times, each starting with random weights $[0, 1]$, and stopping at zero error or 1000 epochs.
- **Success Criteria**:
